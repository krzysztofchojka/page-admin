                    ...
                    <?php else: ?>
                        ...
                        <tr>
                            ...
                            <td class="px-5 py-5 border-b border-gray-200 bg-white text-sm">
                                <a href="/admin/forms/builder?id=<?= $form['id'] ?>" class="text-blue-600 hover:text-blue-900 mr-3">Edit Builder</a>
                                <a href="/admin/forms/submissions?id=<?= $form['id'] ?>" class="text-green-600 hover:text-green-900 font-bold">View Submissions</a> 
                            </td>
                        </tr>
                        <?php endforeach; ?>
                    <?php endif; ?>
