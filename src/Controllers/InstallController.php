...
class InstallController {
    public function index() {
        ...
        try {
            ...
            // [POPRAWKA]: Brakująca tabela szablonów blokowała połowę panelu!
            $db->query("CREATE TABLE IF NOT EXISTS pa_templates (id INT UNSIGNED AUTO_INCREMENT PRIMARY KEY, title VARCHAR(255), html_content LONGTEXT, is_active TINYINT(1) DEFAULT 1)");
