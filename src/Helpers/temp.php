                    ...
                    if ($showThankYou) {
                        ...
                        foreach ($fields as $field) {
                            ...
                            if ($type === 'file') {
                                ...
                                echo "<input type='file' id='{$fieldId}' class='absolute inset-0 w-full h-full opacity-0 cursor-pointer z-10 file-input' {$currentReqAttr} {$allowMultiple} data-allowed-exts='{$allowedExtsRawEscaped}' {$acceptAttr}>";
                        ...
                        (function() {
                            ...
                            form.querySelectorAll(".async-file-upload").forEach(container => {
                                ...
                                function addUploadedFileUi(fileData, displayName) {
                                    ...
                                    const dlUrl = "/form-download?file=" + encodeURIComponent(fileData.storage_name) + "&orig=" + encodeURIComponent(displayName);
